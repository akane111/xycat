    ...
    <div class="time">
      ...
      <div class="item-style">
        ...
        <el-popover placement="right" width="320" trigger="hover">
          <div>
            <div class="item-sales">联系人姓名：<span class="sales-text">{{data.ownName}}</span></div>
            <div class="item-sales">联系人地址：<span class="sales-text">{{data.address}}</span></div>
            <div class="item-sales">联系人方式：<span class="sales-text">15198007215</span></div>
