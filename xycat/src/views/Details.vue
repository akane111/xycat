    ...
    <div class="info">
      ...
      <div class="item-style">
        ...
        <div class="btn-content">
          <el-button type="danger" @click="addShopcartClick" v-if="data.type == 'goods'">领养猫咪</el-button>
          <el-popover placement="right" width="320" trigger="hover">
            <div>
              <div class="item-sales">提供信息同学：<span class="sales-text">{{updateUserData.userName}}</span></div>
