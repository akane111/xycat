<template>
  <div class="add-address">
    ...
    <div v-for="(item,index) in allAddressData" :key="index"  class="default-address-container">
      <div>
        <div class="address-item">领养人：{{item.consignee}}</div>
        <div class="address-item">领养人地址：{{item.addressDetail}}</div>
        <div class="address-item">领养人手机号：{{item.phone}}</div>
      </div>
      <div class="right-btn">
        <el-tag style="position:relative;top:-40px;right:-138px;margin-right: 20px;" v-if="item.isDefault" type="success">默认领养人地址</el-tag>
    ...
    <el-dialog title="更换地址" :visible.sync="dialogVisible" width="580px" :before-close="handleClose">
      <el-table ref="multipleTable" :data="allAddressData" tooltip-effect="dark" style="width: 100%"
       @select="handleSelectionChange">
        ...
        <el-table-column label="领养人" prop="consignee" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="addressDetail" label="领养人地址" show-overflow-tooltip></el-table-column>
        <el-table-column prop="phone" label="领养人手机号" width="120" show-overflow-tooltip></el-table-column>
      </el-table>
    ...
    <el-dialog :title="title" :visible.sync="showAdd" width="580px" :before-close="closeAdd">
      <el-form :model="addressData" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="领养人：" prop="consignee">
          <el-input v-model="addressData.consignee"></el-input>
        </el-form-item>
        <el-form-item label="领养地址：" prop="addressDetail">
