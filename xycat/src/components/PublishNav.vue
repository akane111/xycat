<template>
  <div class="details-nav">
    <el-menu :default-active="$store.state.publishActiveIndex"
      ...
      <el-menu-item v-show="this.$route.path === '/home/addmessage/publishgoods'" index="1" @click="PublishGoodsClick">发布猫咪信息</el-menu-item>
      <el-menu-item v-show="this.$route.path === '/home/addmessage/publishneeds'" index="2" @click="PublishNeedsClick">发布志愿者需求</el-menu-item>
