<template>
  <div class="receiving-address">
    ...
    <div class="default-address-container">
      <div>
        <div class="address-item">领养人：{{addressData.consignee}}</div>
        <div class="address-item">领养人地址：{{addressData.addressDetail}}</div>
        <div class="address-item">领养人手机号：{{addressData.phone}}</div>
      </div>
      
      <el-button type="success" @click="handleChange">更换领养信息</el-button>     
    </div>
