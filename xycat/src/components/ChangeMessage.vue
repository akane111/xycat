<template>
  <div class="changemessage">
    ...
    <el-dialog title="猫咪信息" :visible.sync="dialogFormVisible" class="modify-message">
      <el-form label-width="100px">
        <el-form-item label="猫咪图片" :label-width="formLabelWidth">
          <img
      ...
      <el-form :model="form">
        <el-form-item label="猫咪标题" :label-width="formLabelWidth">
          <el-input
        ...
        <el-form-item label="猫咪内容" :label-width="formLabelWidth">
          <textarea
