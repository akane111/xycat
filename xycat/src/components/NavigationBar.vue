  ...
  <div class="navigation-bar">
    <span class="initiator">
      <div class="logo-content">
        <div style="display:flex;flex-direction:row;justify-content:flex-start;align-items:center;">
          <img src="../assets/logo.jpg" style="height:50px;" alt="" />
          <div class="logo-text">
            <div>西柚猫咪</div>
    ...
    <div class="menu-content" v-cloak>
      <el-menu :default-active="$store.state.activeIndex" mode="horizontal" @select="handleSelect"
        ...
        <!-- //放地图 -->
        <el-menu-item index="2" class="item" @click="goodsBtn">猫咪信息</el-menu-item>

        <el-menu-item index="3" class="item" @click="purchaseBtn">志愿者招募</el-menu-item>

        <el-menu-item index="4" class="item" @click="knowledgesBtn">宣传教育</el-menu-item>
        ...
        <el-submenu index="7">
          <template slot="title">捐赠支持</template>
          <el-menu-item index="7-1" @click.native="smartMatchBtn">智能匹配</el-menu-item>
          <el-menu-item index="7-2" @click.native="financingBtn">捐赠方式</el-menu-item>
        </el-submenu>
        ...
        <el-submenu index="8" v-else>
          ...
          <el-menu-item index="8-4" @click.native="goodsManage" v-if="$store.getters.isAdmin">猫咪管理</el-menu-item>
