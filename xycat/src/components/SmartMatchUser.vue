  ...
  <div class="add-address">
    <div class="title">
      <el-button type="success" style="margin-top: 10px" v-if="allIntentionData != ''"
        @click="lookIntention">我的捐赠意向</el-button>
    </div>
    <div v-if="look === true">
    ...
    <el-button type="success" style="margin-top: 10px" v-if="allIntentionData == ''" @click="handleAdd">添加融资意向</el-button>

    <el-dialog :title="title" :visible.sync="showAdd" width="900px" :before-close="closeAdd">
      <el-form :model="intentionData" ref="ruleForm" label-width="170px" class="demo-ruleForm">
        ...
        <el-form-item label="学号：" prop="item">
          <el-input v-model="intentionData.item"></el-input>
        </el-form-item>
        <el-form-item label="投放区域（1/2/3）区：" prop="area">
          <el-input v-model="intentionData.area"></el-input>
        </el-form-item>

        <el-form-item label="意向资助期：" prop="repaymentPeriod">
          <el-select v-model="value" placeholder="意向资助期：">
    ...
    <div class="goods-box">
      <div class="goods" v-for="(item, index) in allRecommendData" :key="index" @click="detailsClick(item.userName)"
        ...
        <img class="goods-img" v-if="item.avatar != ''" :src="$store.state.imgShowRoad + '/file/' + item.avatar" alt="" />
        ...
        <div class="info">
          ...
          <span class="initiator4" @click="detailsClick(item.userName)">学号：{{ item.item }}</span><br />
          ...
          <span class="initiator4" @click="detailsClick(item.userName)" v-if="item.area != -1">资金投放区域： 区{{ item.area }}
          </span>
          <span class="initiator4" @click="detailsClick(item.userName)" v-else>使用区域：-区 </span>
        </div>
      </div>
    </div>
  </div>
